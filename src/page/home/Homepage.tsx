  ...
  <section className="relative flex flex-col items-center justify-center text-center overflow-hidden mt-16 sm:mt-20 md:mt-24 px-4 sm:px-6 lg:px-8">
    <div className="relative z-10 flex flex-col items-center w-full max-w-3xl mx-auto">
      <div className="flex items-center gap-0 border border-[#303030]  overflow-hidden shadow-sm">
        <span className="px-3 sm:px-4 py-1.5 text-[10px] text-[#FAFAFA]  border-r border-[#303030]">Introducing Helix AI</span>
        <a href="#" className="px-3 sm:px-4 py-1.5 text-[10px] bg-[#F5F5F5] text-black  transition-colors flex gap-1.5 items-center justify-center">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-[45px]  text-[#E6ECEC] leading-[1] -tracking-[2px] mb-6 mt-4 ">
        ...
        learning roadmaps build with Helix AI
      </h1>

      <p className="text-sm text-[#9A9996] max-w-lg mx-auto">Write with precision, showcase with confidence, and learn with clarity all inside one focused platform built for developers.</p>
    </div>

    <div className="relative w-full  max-w-6xl mt-12 sm:mt-16 md:mt-20">
      <img src="https://i.pinimg.com/736x/6b/51/75/6b51750159bbaa442d603a3c860d5e89.jpg" className="w-full h-150 rounded-sm opacity-50" alt="" />
    ...
    <div className="w-full max-w-6xl text-start mt-32 sm:mt-40 md:mt-52 mb-6 px-2">
      <h1 className="text-lg sm:text-xl md:text-[23px] text-[#E6ECEC]/90">
        All the Essential Tools to Create Professional Documents, Showcase <br />
    ...
    <div className="flex flex-col sm:flex-row justify-center gap-1 mt-6 mb-24 w-full max-w-6xl">
      <div className="w-full sm:w-64 md:w-72 h-72 sm:h-80 rounded-sm overflow-hidden relative shrink-0">
        <img src="https://i.pinimg.com/736x/ca/eb/4d/caeb4de0657fb92409b28549d36cabdc.jpg" alt="visual" className="w-full h-full object-cover opacity-50" />
        <h1 className="absolute  bottom-6 left-6 text-white text-[16px]">Platform Features</h1>
      </div>

      <a href="#" className="w-full sm:w-64 md:w-72 bg-[#0A0A0A] text-[#EDECEC] text-sm text-start rounded-sm border border-[#303030]/30 p-6 flex flex-col justify-between transition-all">
    ...
    <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 mb-16 mt-16 px-2">
      <div className="flex-col text-start w-full md:max-w-xl">
        <h2 className="text-2xl sm:text-3xl text-[#EDECEC] mb-2">We bring everything you need to build and grow into one place.</h2>
        <p className="mb-8 text-[#E6ECEC]/30 mt-3 text-sm sm:text-base">
          Create professional resumes, showcase your projects clearly, and grow with structured learning paths all inside one focused and easy-to-use platform.
        </p>
        <Link href="/login" className="px-5 py-1.5 bg-[#F0EDE7] text-black text-sm font-medium rounded-[2px] hover:bg-stone-700 transition-colors  tracking-wide">
          Get started now
        </Link>
      </div>
    ...
    <div className="w-full max-w-6xl rounded-sm bg-[#0A0A0A] border border-[#393732]/20 mb-16 flex flex-col items-center justify-center py-16 px-6 mt-20 sm:mt-32 md:mt-40 text-center">
      <h1 className="text-[#E6ECEC]/80 mb-4 text-sm sm:text-base">Build Your Profile, Showcase Your Work, and Grow With Direction</h1>
      <Link href="/login" className="px-5 py-1.5 bg-[#F0EDE7] text-black text-sm font-medium rounded-sm hover:bg-stone-700 transition-colors font-mono tracking-wide">
        Try now
      </Link>
    </div>
  </section>
